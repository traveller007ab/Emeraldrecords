    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto">
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-slate-100 mt-4">EmeraldRecords</h1>
          <p className="text-slate-400 mt-2">Your AI-powered data workspace.</p>
        </div>
        
        <div className="bg-slate-800/50 border border-slate-700 p-8 rounded-2xl shadow-2xl shadow-emerald-500/10">
          <h2 className="text-center text-xl font-semibold text-white mb-6">Connect to Your Supabase Project</h2>
